...
import { type CreateTodoFormData, useTodoFormSchema } from './useTodoFormSchema';
        ...
        <S.ButtonsArea>
          ...
          <S.ButtonsRow>
            <Button
              onPress={goBack}
              showIcon
              color={themeMode.colors.white}
              buttonColor={themeMode.colors.danger}
              name="x"
              title={t('titleButtonCancel')}
            />
            <Button
              showIcon
              onPress={handleSubmit(handleAddTodo)}
              name="check"
              title={t('titleButtonSave')}
            />
          </S.ButtonsRow>
        </S.ButtonsArea>
      </S.InputArea>
